    ...
    <div class="app">
        ...
        <div class="wrap-banner">
            <div class="banner">
                ...
                <div class="ads_main">
                    <div style="width: 1200px;" class="ads_main-img"><img style="width: 100%;" src="assets/img/gifadschinh.gif" alt=""></div>
                </div>
            </div>
        </div>
        ...
        <div style="HEIGHT: 100%" class="container">
            ...
            <div class="homepage-mall-section">
                <div class="shopee-header-section shopee-header-section--simple">
                    <div class="shopee-header-section__header">
                        <div class="shopee-header-section__header__title">
                            <div class="header__title-khoi">
                                <a href="" class="header__title-khoi-text">PBA MALL</a>
                        ...
                        <div class="shopee-header-section__header-link">
                            <button class="shopee-button-no-outline">
                                <a href="index.html" class="shopee-button-btn-khoi-link">
                    ...
                    <div style="display: flex; flex-wrap: wrap;">
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/vn-50009109-c600fb68d67e7e5164bc646f0bb1e229" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/dcb6014c56264e43fc0ff2d1aac01152" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/1ed564e0dab9744155d521c8efcbc439" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/4eb1fd88a044d66267f56fa26be01ea0" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/fed4b97d2e56f102647bb6bccb086d02" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/57051eb3b9e4402159baa8ef4efb0750" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/37d7186a9f7478f13cfc5abfc8cac55c" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/ddc75185f9fb776d74e7483c4bea3187" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/29bed4380e5d22c19db3e70bdf852754" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/63072c90d0ed6f1acdbc301f4e35f890" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/5c1936f863ed34b0e77299b2dbb96365" alt=""></div>
                        <div style="width: calc(1200px / 6); border: 1px solid rgba(0, 0, 0, .05); cursor: pointer;"><img style="width: 100%; box-sizing: border-box;" src="https://down-vn.img.susercontent.com/file/513f589c10254512669d3d8b50a6dea7" alt=""></div>
                    </div>
                </div>
            ...
            <div class="look-for-top">
                <div class="look-for-top-header">
                    <div style="color: #999999;" class="look-for-top-header-content">KIỂU CÁCH THỊNH HÀNH - DIỆN BẢNH MẶC SANG</div>
                    ...
                    <ul class="look-for-top-body-list">
                        <li class="look-for-top-body-item">
                            <div class="look-for-top-body-item-img">
                                <img src="https://down-vn.img.susercontent.com/file/vn-50009109-31f654102e8a96eee10b631c0cb0d0b7" alt="">
                            </div>
                            <div class="look-for-top-body-item-mota" style="color: red; text-align: center;">26.000 VND</div>
                        </li>
                        <li class="look-for-top-body-item">
                            <div class="look-for-top-body-item-img">
                                <img src="https://down-vn.img.susercontent.com/file/vn-50009109-e413a635a7447d15502ed9b612209616" alt="">
                            </div>
                            <div class="look-for-top-body-item-mota" style="color: red; text-align: center;">26.000 VND</div>
                        </li>
                        <li class="look-for-top-body-item">
                            <div class="look-for-top-body-item-img">
                                <img src="https://down-vn.img.susercontent.com/file/vn-50009109-d3b8e481350ebefafdcc8b57b6191edc" alt="">
                            </div>
                            <div class="look-for-top-body-item-mota" style="color: red; text-align: center;">26.000 VND</div>
                        </li>
                        <li class="look-for-top-body-item">
                            <div class="look-for-top-body-item-img">
                                <img src="https://down-vn.img.susercontent.com/file/vn-50009109-6a80a8a1a399ad487780112d4c07a74e" alt="">
                            </div>
                            <div class="look-for-top-body-item-mota" style="color: red; text-align: center;">26.000 VND</div>
                        </li>
                        <li class="look-for-top-body-item">
                            <div class="look-for-top-body-item-img">
                                <img src="https://down-vn.img.susercontent.com/file/vn-50009109-a432f617ea2d696fcef811d11eaffba5" alt="">
                            </div>
                            <div class="look-for-top-body-item-mota" style="color: red; text-align: center;">26.000 VND</div>
                        </li>
                        <li class="look-for-top-body-item">
                    ...
                    <div class="grid__row app__content">
                        <div class="grid__column-2">
                            <nav class="category">
                                ...
                                <ul class="category-list">
                                    ...
                                    <li class="category-item">
                                        <a href="#" class="category-item__link">Áo vest và Blazer</a>
                                    </li>
                                    <li class="category-item">
                                        <a href="#" class="category-item__link">Áo Hoodie, Áo Len & Áo Nỉ</a>
                                    </li>
                                    <li class="category-item">
                                        <a href="#" class="category-item__link">Quần Jeans</a>
                                    </li>
                                    <li class="category-item">
                                        <a href="#" class="category-item__link">Quần dài/ Quần âu</a>
                                    </li>
                                </ul>
                            ...
                            <div class="filter-container">
                                ...
                                <button class="clear-button">XÓA TẤT CẢ</button>
                            </div>
                        ...
                        <div class="grid__column-10">
                            <div class="home-filter">
                                ...
                                <button class="home-filter__btn btn--primary" style="color: #fff; background-color: var(--primary-color2);">Phổ Biến</button>
                                <button class="home-filter__btn">Mới Nhất</button>
                                ...
                                <div class="home-filter__page"></div>
                                <span class="home-filter__page-num">
                                    <span class="home-filter__page-current">1</span>/14
                                </span>
                                <div class="home-filter__page-control">
                                    <a href="" class="home-filter__page-btn home-filter__page-btn--disabled">
                                        <i class="home-filter__page-icon fa-solid fa-angle-left"></i></a>
                                        <a href="" class="home-filter__page-btn">
                                            <i class="home-filter__page-icon fa-solid fa-angle-right"></i></a>
                                </div>
                            </div>
                            ...
                            <!-- <div class="home-product">
                                <div class="grid__row">
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/43f810b27d9851a377b1daad22f240bc_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                ...
                                                <div class="home-product-item__action">
                                                    ...
                                                    <span class="home-product-item__sold">Đã bán 66</span>
                                                </div>
                                                ...
                                                <div class="home-product-item__sale-off">
                                                    <span class="home-product-item__sale-off-percent">90%</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lu0v230a9vrz18_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                                ...
                                                <div class="home-product-item__origin">
                                                    <span class="home-product-item__brand">adidas</span>
                                                    <span class="home-product-item__origin-name">Trung quốc</span>
                                                </div>
                                                <div class="home-product-item__favourite">
                                                    <i class="fa-solid fa-check"></i>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-li5a01wd8teae9_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                                ...
                                                <div class="home-product-item__origin">
                                                    <span class="home-product-item__brand">doce</span>
                                                    <span class="home-product-item__origin-name">Trung quốc</span>
                                                </div>
                                                <div class="home-product-item__favourite">
                                                    <i class="fa-solid fa-check"></i>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lu30liy2hp275c_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/ba3191b02e3f88c325fc2fec21308fc3_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lryplak1nfrt2c_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-ltplkaq5khe574_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lnxp9r3zh1wte2_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-ltm7l60xudql4c_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lk0q6n7nifn886_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lveyrzihrvkd14_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134201-7r98o-lw9um79b1xtv38_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lvh7ebpbrxjh83_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lw3r2mfcs257ea_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                                    ...
                                    <div class="grid__column-2-4">
                                        <a href="single.html"><div class="home-product-item" href="#">
                                            <div class="home-product-item__img" style="background-image: url(https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lv1nahngymt50d_tn);">
                                                <h4 class="home-product-item__name">Đồ bộ thể thao nam mặc hè xuyên biên giới, Chất thun cotton thấm hút mồ hôi cực tốt Kiểu dáng Slim Fit siêu đẹp DB37</h4>
                                                <div class="home-product-item__price">
                                                    <span class="home-product-item__price--old">1.200.000</span>
                                                    <span class="home-product-item__price--current">200.000</span>
                            ...
                            <ul class="pagination home-product_pagination">
                                ...
                                <li class="pagination-item">
                                    <a href="" class="pagination-item__link">14
                                    </a>
                                </li>
                                <li class="pagination-item">
                                    <a href="" class="pagination-item__link">
