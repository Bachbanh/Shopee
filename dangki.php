...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirm_password) {
        ...
        $checkEmail = $pdo->prepare("SELECT * FROM User WHERE email = :email");
        ...
        <div class="login">
            <div class="login-header">
                <div class="login-header-box">
                    ...
                    <div class="login-header-box-text">ĐĂNG KÍ</div>
                ...
                <div class="login-content-main">
                    ...
                    <div class="login-content-main-box">
                        <div class="login-content-main-box-header">
                            <div class="login-content-main-box-header-text">Đăng kí</div>
                        </div>
                        <div class="login-content-main-box-content">
                            <div class="login-content-main-box-content--khoi">
                                <form action="dangki.php" method="post">
                                    <div style="margin-bottom: 31px;">
                                        <div class="login-form-input">
                                            <input class="input-ten-dang-nhap" type="email" id="email" name="email" required placeholder="Email"><br>
                                        </div>
                                    </div>
                                    <div style="margin-bottom: 31px;">
                                        <div class="login-form-input">
                                            <input class="input-ten-dang-nhap" type="password" id="password" name="password" required placeholder="Mật khẩu"><br>
                                        </div>
                                    </div>
                                    <div style="margin-bottom: 31px;">
                                        <div class="login-form-input">
                                            <input class="input-ten-dang-nhap" type="password" id="confirm_password" name="confirm_password" required placeholder="Nhâp lai mật khẩu"><br>
                                        </div>
                                    </div>
                                    <button type="" style="margin-bottom: 31px;" class="login-dnhap">Đăng kí</button>
                                ...
                                <!-- <div style="margin-top: 20px;" class="login-content-main-box-content--khoi-fb-gg">
                                ...
                                <!-- <div style="padding: 0 25px; margin-right:5px; text-align: center; font-size: 1.2rem; margin-top: 31px;">
                                    Bằng việc đăng kí, bạn đã đồng ý với Shopee về 
                                    <a style="color: #EE4D2D; font-size: 1.2rem;font-weight: 500; margin-left: 6px;" href="">Điều khoản dịch vụ</a>  &<a style="color: #EE4D2D; font-size: 1.2rem;font-weight: 500; margin-left: 6px;" href="">Chính sách bảo mật</a>
                                </div> -->
                            </div>
