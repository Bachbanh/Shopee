            ...
            <selection id="slt-pro">
                ...
                <selection class="slt-pro-right" style="padding-left: 10px">
                    ...
                    <form action="add_to_cart.php" method="post" style="margin-top: 16px; display: flex; margin-left: 27px;">
                        ...
                        <div class="GpmJtT shopee-input-quantity" style="display: flex;align-items: center;background: #fff;">
                            <div class="WNSVcC" aria-label="Decrease" id="btnTru">
                            ...
                            <input class="WNSVcC g2m9n4" type="text" role="spinbutton" aria-valuenow="1" value="1" id="soLuong" name="quantity">
                            <div class="WNSVcC" aria-label="Increase" id="btnCong">
        ...
        <div class="wrap-footer">
            ...
            <div class="wrap-footer-end">
                <div class="footer-end">
                    <div class="footer-end-tong-box-khoi">
                        ...
                        <!-- cot2  -->
                        <div class="footer-end-tong-khoi">
                            <div class="footer-end-list-header">VỀ PKA</div>
                            <ul class="footer-end-list">
                                <li class="footer-end-item">
                                    <a href="">
                                        <span>Giới Thiệu Về PKA Việt Nam</span>
                                    </a>
                                </li>
                                <li class="footer-end-item">
                                    <a href="">
                                ...
                                <li class="footer-end-item">
                                    <a href="">
                                        <span>Chương Trình Tiếp Thị Liên Kết PKA</span>
                                    </a>
                                </li>
                                <li class="footer-end-item">
                                    <a href="">
                        ...
                        <!-- cot5  -->
                        <div class="footer-end-tong-khoi">
                            <div class="footer-end-list-header">TẢI ỨNG DỤNG PKA NGAY THÔI</div>
            ...
            <div class="wrap-footer-2024">
                <div class="footer-2024">
                    <div class="footer-2024-text1">© 2024 PKA. Tất cả các quyền được bảo lưu.</div>
            ...
            <div class="wrap-footer-last">
                <div class="footer-last">
                    ...
                    <div class="footer-last-khoi-2-text">Công ty TNHH PKA</div>
                    ...
                    <div class="footer-last-khoi-2-text-style2">© 2015 - Bản quyền thuộc về Công ty TNHH PKA</div>
                </div>
            </div>
        </div>
